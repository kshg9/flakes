...
echo "=== Copying flake to /mnt/persist/system/etc/nixos/nyx ==="
mkdir -p /mnt/persist/system/etc/nixos/nyx
rsync -a --exclude='.git' --exclude='result' --exclude='tmp' "$FLAKE_ROOT/" "/mnt/persist/system/etc/nixos/nyx/"
